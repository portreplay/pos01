                    ...
                    <tbody id="penjualan-data">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <span class="label label-success">Stok : <?php get_stok($kd_barang_penjualan); ?>
                                </span>
                            </td>
                            <td data-kd-barang="<?php echo $kd_barang_penjualan; ?>" class="row_kd_barang">
                                <form action="core/send_data/update_pengadaan.php?ref=penjualan&follow=<?php echo $kd_barang_penjualan; ?>" method="post" class="form-update-pengadaan">
                            ...
                            <td>
                                ...
                                ?>
                                <form action="core/send_data/update_diskon.php?ref=penjualan&follow=<?php echo $kd_barang_penjualan; ?>" method="post" class="form-update-diskon">
                                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="list_pelanggan" id="list_pelanggan" class="form-control" required="required">
                            <option value="">Pilih Pelanggan</option>
                                <?php 
                                $get_list_pelanggan = $mysqli->query("SELECT * FROM tbl_pelanggan");
                                                ...
                                                success: function (data) {
                                                    if(data.add_status == true) {
                                                        swal({
                                                                ...
                                                                cancelButtonText: "Tidak, Lihat Daftar Penjualan",   
                                                                closeOnConfirm: true,   
                                                                closeOnCancel: false 
                                                            }, 
                                                            function(isConfirm) {   
                                                                if (isConfirm) {     
                                                                     window.location = 'penjualan.php?mode=add';
                                                                } else {     
                                                                    $.ajax({
                                                                        url: 'clear.php?ref=penjualan',
                                                                        type: 'POST',
